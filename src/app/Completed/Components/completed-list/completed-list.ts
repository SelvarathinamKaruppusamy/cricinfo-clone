...
console.log('Converted:',
  Number(this.route.snapshot.paramMap.get('matchNo'))
);
  ...
  getTopBowlers(bowlingList: any[] | undefined): any[] {
    ...
    return [...bowlingList]
      ...
      .sort((a, b) => {
        if (b.wickets !== a.wickets) {  //decending order sorting to get higher wickets comes first
  ...
  getPotmStats(): string {
    ...
    for (const team of this.match.teams) {// if batter POM
